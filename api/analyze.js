    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          ingredients: { type: "STRING", description: "原材料の記載があればそのまま抜粋。無ければ空文字" },
        ...
        required: ["index", "relevant", "attrHits"],
      },
    },
  },
...
- ingredients: 原材料の記載があれば抜粋（無ければ空文字）
...
index_1.html をダウンロードしました エクスプローラーで表示
