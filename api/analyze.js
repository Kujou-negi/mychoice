    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          summary: { type: "STRING", description: "商品名や説明文にある付随情報のうち、他の項目（specs・属性）に当てはまらないが参考になる一言（例: 販売者名、製造元、ギフト向けかどうかなど）。無ければ空文字" },
          specs: {
            type: "ARRAY",
...
- summary: shortNameやspecs/attrHitsのどれにも当てはまらないが、ユーザーの参考になりそうな一言（販売者名・製造元・ギフト向けかどうかなど）。例:「飯綱町ふるさと振興公社が製造」。無ければ空文字。他の項目と同じ内容を繰り返さないこと。
