    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          ingredients: { type: "STRING", description: "原材料の記載があれば、原材料名だけをカンマ区切りで抜粋（例: 梅,砂糖,はちみつ）。内容量・産地・保存方法・製造者・容器などの情報は含めない。原材料の記載が無ければ空文字" },
...
- ingredients: 原材料名だけをカンマ区切りで抜粋（例:「梅,砂糖」）。内容量の数値・産地・保存方法・製造者・販売者などはingredientsに含めず、summaryやquantityの方に入れること。原材料の記載が無ければ空文字
